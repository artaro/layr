...
const translations: Record<Language, Record<string, string>> = {
    th: {
        ...
        'landing.hero': 'สร้างชีวิต ทีละชั้น.',
        'landing.heroDesc': 'Layr ช่วยให้คุณสร้างรากฐานที่แข็งแกร่ง — เริ่มจากการเงิน แล้วเติบโตไปทุกด้านของชีวิต 🧱',
        'landing.getStarted': 'เริ่มสร้างเลเยอร์แรก',
        'landing.ctaSecondary': 'ดูวิธีการทำงาน',
        'landing.feature1': 'ติดตามรายจ่าย',
        'landing.feature1Desc': 'ดูว่าเงินหายไปไหนทุกบาท',
        'landing.feature2': 'นำเข้าใบแจ้งยอด',
        'landing.feature2Desc': 'อัปโหลด PDF/CSV จากธนาคาร',
        'landing.feature3': 'เป้าหมายงบประมาณ',
        'landing.feature3Desc': 'ตั้งเป้าหมาย & ไม่หลุดงบ',
        'landing.feature4': 'กราฟอัจฉริยะ',
        'landing.feature4Desc': 'วิเคราะห์การใช้จ่ายแบบสวยงาม',
        'landing.layersTitle': 'แอปเดียว หลายเลเยอร์',
        'landing.layersDesc': 'ชีวิตไม่ได้มีแค่มิติเดียว — Layr ให้คุณสร้าง & ติดตามทุกด้าน',
        'landing.layer.financial': '💰 การเงิน',
        'landing.layer.financialDesc': 'ติดตามรายรับ-รายจ่าย นำเข้าใบแจ้งยอด วิเคราะห์งบประมาณ',
        'landing.layer.knowledge': '📚 ความรู้ & ทักษะ',
        'landing.layer.knowledgeDesc': 'ติดตามเป้าหมายการเรียนรู้ ทักษะ คอร์สต่างๆ',
        'landing.layer.health': '💪 สุขภาพ',
        'landing.layer.healthDesc': 'ฟิตเนส โภชนาการ นิสัยด้านสุขภาพ',
        'landing.layer.relationships': '🤝 ความสัมพันธ์',
        'landing.layer.relationshipsDesc': 'เครือข่าย คอนเนคชัน สุขภาพสังคม',
        'landing.layer.custom': '➕ เลเยอร์ที่คุณต้องการ',
        'landing.layer.customDesc': 'เพิ่มเลเยอร์อะไรก็ได้ที่สำคัญสำหรับคุณ',
        'landing.layer.active': 'ใช้งานได้แล้ว',
        'landing.layer.comingSoon': 'เร็วๆ นี้',
        'landing.howTitle': '3 ขั้นตอนง่ายๆ',
        'landing.step1Title': 'นำเข้า',
        'landing.step1Desc': 'อัปโหลดใบแจ้งยอดธนาคาร PDF/CSV หรือเพิ่มรายการด้วยตัวเอง',
        'landing.step2Title': 'ติดตาม',
        'landing.step2Desc': 'ดูรายรับ-รายจ่ายแยกตามหมวดหมู่ บัญชี และช่วงเวลา',
        'landing.step3Title': 'เติบโต',
        'landing.step3Desc': 'วิเคราะห์แนวโน้ม ตั้งเป้าหมาย และสร้างนิสัยการเงินที่ดี',
        'landing.whyTitle': 'ทำไมต้อง Layr?',
        'landing.why1Title': 'ฟรีตลอดไป',
        'landing.why1Desc': 'ฟีเจอร์ครบ ไม่มีค่าสมัคร ไม่มี paywall',
        'landing.why2Title': 'ข้อมูลเป็นของคุณ',
        'landing.why2Desc': 'ขับเคลื่อนด้วย Supabase — ไม่ขายข้อมูลของคุณ',
        'landing.why3Title': 'ทันสมัย',
        'landing.why3Desc': 'UI สวย ลื่นไหล ออกแบบมาเพื่อคนรุ่นใหม่',
        'landing.why4Title': 'นำเข้าอัจฉริยะ',
        'landing.why4Desc': 'AI วิเคราะห์ใบแจ้งยอดธนาคารให้อัตโนมัติ',
        'landing.trustTitle': 'ปลอดภัย เป็นส่วนตัว เป็นของคุณ',
        'landing.trustDesc': 'ข้อมูลของคุณถูกเข้ารหัสและจัดเก็บอย่างปลอดภัยด้วย Supabase — เราไม่ขาย ไม่แชร์ ไม่หาเงินจากข้อมูลของคุณ',
        'landing.finalCta': 'เริ่มสร้างเลเยอร์ของคุณ',
        'landing.finalCtaDesc': 'ฟรีตลอดไป ไม่ต้องใช้บัตรเครดิต',
        ...
        // ── Portal ──
        'portal.title': 'เลเยอร์ของคุณ 🧱',
        'portal.subtitle': 'สร้างชีวิตทีละชั้น',
        'portal.selectTemplate': 'เลือกเทมเพลตเลเยอร์',
        'portal.starterKit': 'ชุดเริ่มต้น',
        'portal.starterKitDesc': 'การเงิน + ความรู้ + สุขภาพ',
        'portal.custom': 'กำหนดเอง',
        'portal.customDesc': 'การเงิน + เพิ่มเลเยอร์ของคุณ',
        'portal.enterApp': 'เข้าสู่แอป',
        'portal.yourLayers': 'เลเยอร์ของคุณ',
        'portal.foundation': 'รากฐาน',
        'portal.recommended': 'แนะนำ',
        'portal.layerFinancial': '💰 การเงิน',
        'portal.layerKnowledge': '📚 ความรู้ & ทักษะ',
        'portal.layerHealth': '💪 สุขภาพ',
        'portal.layerCustom': '➕ เพิ่มเลเยอร์',
    },
    ...
    en: {
        ...
        'landing.hero': 'Build Your Life, Layer by Layer.',
        'landing.heroDesc': 'Layr helps you build a strong foundation — start with finances, then grow into every dimension of your life 🧱',
        'landing.getStarted': 'Add Your First Layer',
        ...
        'landing.feature2Desc': 'Upload PDF/CSV from your bank',
        'landing.feature3': 'Budget Goals',
        'landing.feature3Desc': 'Set targets & stay on track',
        'landing.feature4': 'Smart Charts',
        'landing.feature4Desc': 'Beautiful spending analysis',
        'landing.layersTitle': 'One App, Many Layers',
        'landing.layersDesc': 'Life isn\'t one-dimensional — Layr lets you build & track every dimension',
        'landing.layer.financial': '💰 Financial',
        'landing.layer.financialDesc': 'Track income & expenses, import statements, analyze budgets',
        'landing.layer.knowledge': '📚 Knowledge & Skills',
        'landing.layer.knowledgeDesc': 'Track learning goals, skills, and course progress',
        'landing.layer.health': '💪 Health',
        'landing.layer.healthDesc': 'Fitness, nutrition, and wellness habits',
        'landing.layer.relationships': '🤝 Relationships',
        'landing.layer.relationshipsDesc': 'Networking, connections, and social health',
        'landing.layer.custom': '➕ Your Custom Layer',
        'landing.layer.customDesc': 'Add whatever matters to you',
        'landing.layer.active': 'Active',
        'landing.layer.comingSoon': 'Coming Soon',
        'landing.howTitle': '3 Simple Steps',
        'landing.step1Title': 'Import',
        'landing.step1Desc': 'Upload your bank statement (PDF/CSV) or add transactions manually',
        'landing.step2Title': 'Track',
        'landing.step2Desc': 'See income & expenses by category, account, and time period',
        'landing.step3Title': 'Grow',
        'landing.step3Desc': 'Analyze trends, set goals, and build better financial habits',
        'landing.whyTitle': 'Why Layr?',
        'landing.why1Title': 'Free Forever',
        'landing.why1Desc': 'Full features, no subscription, no paywall',
        'landing.why2Title': 'Your Data, Your Control',
        'landing.why2Desc': 'Powered by Supabase — we never sell your data',
        'landing.why3Title': 'Modern & Beautiful',
        'landing.why3Desc': 'Clean UI designed for the way you live',
        'landing.why4Title': 'Smart Import',
        'landing.why4Desc': 'AI-powered bank statement parsing',
        'landing.trustTitle': 'Secure. Private. Yours.',
        'landing.trustDesc': 'Your data is encrypted and stored securely with Supabase — we don\'t sell, share, or monetize your information',
        'landing.finalCta': 'Start Building Your Layers',
        'landing.finalCtaDesc': 'Free forever. No credit card required.',
        ...
        // ── Portal ──
        'portal.title': 'Your Layers 🧱',
        'portal.subtitle': 'Build your life, layer by layer',
        'portal.selectTemplate': 'Choose your layer template',
        'portal.starterKit': 'Starter Kit',
        'portal.starterKitDesc': 'Financial + Knowledge + Health',
        'portal.custom': 'Custom',
        'portal.customDesc': 'Financial + add your own layers',
        'portal.enterApp': 'Enter App',
        'portal.yourLayers': 'Your Layers',
        'portal.foundation': 'Foundation',
        'portal.recommended': 'Recommended',
        'portal.layerFinancial': '💰 Financial',
        'portal.layerKnowledge': '📚 Knowledge & Skills',
        'portal.layerHealth': '💪 Health',
        'portal.layerCustom': '➕ Add Layer',
    },
};
