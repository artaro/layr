...
const translations: Record<Language, Record<string, string>> = {
    th: {
        ...
        'app.tagline': 'สร้างชีวิตดีขึ้น ทีละชั้น 🧱',
        ...
        'landing.hero': 'สร้างชีวิตดีขึ้น ทีละชั้น.',
        'landing.heroDesc': 'Layr ช่วยให้คุณพัฒนาทุกด้านของชีวิต — เริ่มจากการเงินเป็นรากฐาน แล้วต่อยอดด้วยทักษะและสุขภาพ 🧱',
        'landing.getStarted': 'เริ่มต้นใช้งาน',
        'landing.ctaSecondary': 'ดูวิธีการทำงาน',
        'landing.phaseNote': 'ตอนนี้เปิดให้ใช้งาน Financial Layer 💰 — เลเยอร์อื่นกำลังมาเร็วๆ นี้',
        'landing.featuresPhase': 'Financial Layer — เปิดให้ใช้งานแล้ว',
        ...
        'landing.layersTitle': 'แอปเดียว สามเลเยอร์',
        'landing.layersDesc': 'ชีวิตไม่ได้มีแค่มิติเดียว — Layr ให้คุณพัฒนาการเงิน ทักษะ และสุขภาพไปพร้อมกัน',
        'landing.layer.financial': '💰 การเงิน',
        'landing.layer.financialDesc': 'ติดตามรายรับ-รายจ่าย นำเข้าใบแจ้งยอด วิเคราะห์งบประมาณ',
        'landing.layer.knowledge': '📚 ทักษะ & การเรียนรู้',
        ...
        'landing.why1Title': 'เริ่มต้นฟรี',
        'landing.why1Desc': 'ฟีเจอร์พื้นฐานฟรี เหมาะกับการใช้งานทุกวัน',
        ...
        'landing.finalCtaDesc': 'เริ่มต้นฟรี ไม่ต้องใช้บัตรเครดิต',
        ...
        'portal.subtitle': 'สร้างชีวิตดีขึ้น ทีละชั้น',
        'portal.enterApp': 'เข้าสู่แอป',
        'portal.viewLayers': 'ดูเลเยอร์ทั้งหมด',
        'portal.foundation': 'รากฐาน',
        'portal.layerFinancial': '💰 การเงิน',
        'portal.layerSkill': '📚 ทักษะ & การเรียนรู้',
    ...
    en: {
        ...
        'app.tagline': 'Build a better life, layer by layer 🧱',
        ...
        'landing.hero': 'Build a Better Life, Layer by Layer.',
        'landing.heroDesc': 'Layr helps you improve every dimension of your life — start with a solid financial foundation, then grow into skills and health 🧱',
        'landing.getStarted': 'Get Started',
        'landing.ctaSecondary': 'See How It Works',
        'landing.phaseNote': 'Financial Layer 💰 is live now — more layers coming soon',
        'landing.featuresPhase': 'Financial Layer — Available Now',
        ...
        'landing.layersTitle': 'One App, Three Layers',
        'landing.layersDesc': 'Life isn\'t one-dimensional — Layr helps you build your finances, skills, and health together',
        'landing.layer.financial': '💰 Financial',
        'landing.layer.financialDesc': 'Track income & expenses, import statements, analyze budgets',
        'landing.layer.knowledge': '📚 Skills & Learning',
        ...
        'landing.why1Title': 'Start Free',
        'landing.why1Desc': 'Core features free — perfect for everyday use',
        ...
        'landing.finalCtaDesc': 'Start free. No credit card required.',
        ...
        'portal.subtitle': 'Build a better life, layer by layer',
        'portal.enterApp': 'Enter App',
        'portal.viewLayers': 'View All Layers',
        'portal.foundation': 'Foundation',
        'portal.layerFinancial': '💰 Financial',
        'portal.layerSkill': '📚 Skills & Learning',
